...
describe 'top rated posts', type: :request do
  before {
    10.times do
      post_id = Post::Create.new.call(login: Faker::Internet.user_name, title: Faker::Lorem.sentence(1), content: Faker::Lorem.sentence(10)).right.id
    ...
    top_post_id = Post::Create.new.call(login: Faker::Internet.user_name, title: 'Top post', content: 'Top content').right.id
